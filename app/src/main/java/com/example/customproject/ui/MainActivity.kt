...
import com.example.customproject.model.data.Message
import com.example.customproject.model.data.timeList.timelists
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customMessage(
            "Hello! Today you are speaking with Tbib, I am here to assist you with your appointment process.\n" +
        ...
        nav_view.setNavigationItemSelectedListener {
            ...
            } else if (it.itemId == R.id.healthSatus) {
    ...
    private fun botResponse(message: String) {
        ...
        GlobalScope.launch {
            ...
            launch(Dispatchers.Main) {
                ...
                if (res.second == 1) {
                    customMessage("It is important to speak with a healthcare professional if you are experiencing severe or persistent symptoms, or if you are at high risk for complications. They can recommend the appropriate treatment and help you manage your symptoms.")
                }
                //Adds it to our local list
                msgList.add(Message(res.first, RECEIVE_ID, timeS))
                //Inserts our message into the adapter
                adt.addMessage(Message(res.first, RECEIVE_ID, timeS))
